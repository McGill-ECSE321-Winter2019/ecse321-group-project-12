...
if (isset($_POST['submitbut'])) {
    if (isset($_POST['studentname'])) {
        $addStud = 'https://ecse321-group12.herokuapp.com/studentsf?userName='.$_POST['studentname'].'&mcgillid='.$_POST['studentId'].'&email='.$_POST['studentEmail'];
        ...
        $getStud = 'https://ecse321-group12.herokuapp.com/students/'.$_POST['studentname'];
        ...
        if (strpos($studidcheck, $_POST['studentname']) !== false) {
            $_SESSION['studadd'] = 1;
           header("Refresh:0");
        } else {
