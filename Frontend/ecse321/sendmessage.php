...
=======
        print($messageId);
        $addmessage = 'https://ecse321-group12.herokuapp.com/newMessage?MessageId='.$messageId.'&SenderName='.$_SESSION['username'].'&ReceiverName='.$_POST['receiver'].'&Content='.$_POST['message'].'&ListofAttachementsIds=null';
>>>>>>> 5e436fa4baddb9981fc85532b65fe7bf7c833f0b
