...
=======
>>>>>>> 5e436fa4baddb9981fc85532b65fe7bf7c833f0b
...
=======
                                        <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." value="<?php if(isset($_POST['email'])) { echo $_POST['email']; } ?>" >
>>>>>>> 5e436fa4baddb9981fc85532b65fe7bf7c833f0b
                                    </div>
