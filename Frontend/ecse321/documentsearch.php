        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Document Search</h1>
                </div>
                        ...
                        <div class="  p-5">
                            <div class="border border border-primary">
                                <div class=" text-center" >
                                    <h1 class="h4 text-gray-900 mb-4">Search for a Document</h1>
                                </div>
                                <form class=" user" method="post" action="">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="docidsearch" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter the document name">
                                    </div>
                                    <h1 class="h5 text-gray-900 mb-4"> Result:</h1>
                                    <br><br>
                                    <input type="text" class="form-control form-control-user" name="resultsearch" value="<?php if(isset($_SESSION['resultsearch'])) { echo $_SESSION['resultsearch']; } ?>" id="exampleInputEmail">
...
if (isset($_POST['submitbutsearch'])) {
    if (isset($_POST['docidsearch'])) {
        $searchDoc = 'https://ecse321-group12.herokuapp.com/getDocument?DocumentId='.$_POST['docidsearch'];

        // $_POST['addDoc'] = $addDoc;

        $cSession = curl_init();
        curl_setopt($cSession,CURLOPT_URL,$searchDoc);
      ...
      //   echo $result;
        ...
        $getDoc = 'https://ecse321-group12.herokuapp.com/getDocument?DocumentId='.$_POST['docidsearch'];
        ...
        $docauthorcheck = $converter->authorName;
        $doctypecheck = $converter->type;

        if (strpos($docidcheck, $_POST['docidsearch']) !== false) {
            $_SESSION['resultsearch'] = 'Document Name: '.$docidcheck.' Document Author: '.$docauthorcheck.' Document Type: '.$doctypecheck;
            header("Refresh:0");
           // print("Succesful");

        } else {
            $_SESSION['resultsearch'] = "There was an error please check your input";
            header("Refresh:0");
        }
