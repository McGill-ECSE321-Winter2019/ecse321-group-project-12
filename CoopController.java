...
public class CoopController {
	...
	@PostMapping(value = { "/setJobOffer", "/setJobOffer/" }) //set job offer
	public StudentDto setStudentJobOffer(@RequestParam(name = "StudentName") String studentName,
			@RequestParam(name = "hasJobOffer") boolean a) throws IllegalArgumentException {
		// @formatter:on
		service.setStudentJobOffer(studentName,a);
		Student s= service.findStudentByUsername(studentName);
		if(s==null) {throw new IllegalArgumentException();}
		return convertToDtob(s); 
	}
